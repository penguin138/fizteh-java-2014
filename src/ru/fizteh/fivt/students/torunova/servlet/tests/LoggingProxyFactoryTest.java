package ru.fizteh.fivt.students.torunova.servlet.tests;

import org.junit.Before;
import org.junit.Test;
import ru.fizteh.fivt.proxy.LoggingProxyFactory;
import ru.fizteh.fivt.students.torunova.servlet.ProxyFactory;
...
public class LoggingProxyFactoryTest {
    ...
    public void testThrowsException() {
        ...
        String buffer = writer.getBuffer().toString();
        assertTrue(buffer.matches(".*<thrown>ru.fizteh.fivt.students.torunova.servlet.tests.TestException</thrown>.*"));
    }
    @Test
