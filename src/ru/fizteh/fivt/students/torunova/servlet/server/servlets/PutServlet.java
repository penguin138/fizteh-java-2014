 ...
 */
public class PutServlet extends MainServlet {
    public PutServlet(TransactionDatabase db) {
        super(db);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            oldValue = transaction.serialize(transaction.put(key, transaction.deserialize(value)));
        } catch (Exception e) {
        ...
        if (oldValue == null) {
            ...
            response.getWriter().write("overwrite " + oldValue);
        }
    }
}
